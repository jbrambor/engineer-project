    ...
    return (
        <div className="footer__content--main-menu_group">
            <ul className="footer__content--main-menu">
                <li className="footer__content--main-menu_title">Go To Travel</li>
            ...
            <ul className="footer__content--main-menu">
                <li className="footer__content--main-menu_title">Recommandations</li>
                <li className="footer__content--main-menu_link">Destinations</li>
            ...
            <ul className="footer__content--main-menu">
                ...
                <li className="footer__content--main-menu_link">Cookies Policy</li>
